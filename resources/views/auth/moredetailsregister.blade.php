<x-app-layout>
    ...
    <div class="divMainContent">
        <div class="divCustomContainer">
            <div class="divRegisterMore">
                <h5 class="headingRM">Increase your chances of getting invited to tests by providing more details about yourself</h5>

                    <form method="post" action="/createprofile" class="dRM">
                        @csrf
                        @if ($errors->any())
                            <div>
                    ...
                    <div class="dTLTCTP"><label class="labelMain">Game genres (types) you like</label>
                        <div class="divRegisterMoreCheckboxes">
                    ...
                    <div class="divRegisterLoginBtn dRLBGrid"><button class="btn btnMain btnMainFull btnMainFullSmall btnMainFullSmallLighter btnMainFullSmallLighterRed" type="button" onclick="event.preventDefault(); document.getElementById('skip').submit();" >Skip</button><button class="btn btnMain btnMainFull btnMainFullSmall btnMainFullSmallLighter" type="submit">Save</button></div>
                    </form>
            </div>
        </div>
    </div>
<form id="skip" method="post" action="/skipprofile">
    @csrf
</form>
