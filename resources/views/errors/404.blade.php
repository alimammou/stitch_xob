<x-app-layout>
    ...
    <div class="divCustomContainer">
        <div class="divPageTitleMain">
            <h2 class="headingPageTitleMain">Seems like you got a <span class="spanHPTM">404</span>&nbsp;error</h2>
        </div>
        <div class="divWallText">
            <p class="paraWT">Hey there,<br><br>It seems like there's nothing here for us to show you.</p>
        </div>
    </div>
