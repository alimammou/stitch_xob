    ...
    <x-slot name="header">
        ...
        <div class="divMainSec dMSNoPad">
            <div class="divCustomContainer">
                ...
                <div class="divDashboardDevOrTester"><a class="linkDOOT" href="/dashboard">Developer</a><a class="linkDOOT linkDOOTActive" href="#">Tester</a></div>
                <div class="divDashboard">
                    <div class="divDTabsHolder">
                        ...
                        <div class="divDTabs"><a class="linkDT" href="/dashboard/tester">Registered tests</a><a class="linkDT linkDTActive" href="/dashboar/storepurchases">Store purchases</a></div>
                    </div>
