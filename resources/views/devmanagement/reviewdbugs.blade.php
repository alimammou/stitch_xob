            ...
            <div class="divCustomContainer">
                ...
                <div class="divDashboard DDManageTest">
                    ...
                    <div class="divDContentHolder">
                        <div class="DDCNav DDCNBugs"><a class="linkDDCN" href="/tests/{{$test->id}}/bugreports">Review Bugs</a><a class="linkDDCN LDDCNActive" href="#">Reviewed Bugs</a><a class="linkDDCN" href="/tests/{{$test->id}}/knownbugs">Known Bugs</a></div>
                        <div class="DDCNB">
                            @foreach($bugs as $bug)
                            <div class="DDCNBItem">
                                ...
                                <div class="DDCNBIBtns"><a class="DDCNBIB" href="/tests/{{$test->id}}/bugreports/reviewed/{{$bug->id}}"><i class="far fa-eye"></i></a></div>
                            </div>
                            @endforeach
                        </div>
