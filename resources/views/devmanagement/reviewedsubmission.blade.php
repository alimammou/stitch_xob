                ...
                <div class="divDashboard DDManageTest">
                    ...
                    <div class="divDContentHolder">
                        ...
                        <div class="DDCFFAction">
                            <div class="DDCFFALegit"><label class="DDCFFALLabel">Is this report spam?</label>
                                <p class="DDCFFALPara">@if($submissions->reward==0) Yes @else No @endif</p>
                            </div>
                            <div class="DDCFFALegit"><label class="DDCFFALLabel">Reward amount</label>
                                <p class="DDCFFALPara">{{$submissions->reward}}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    let reviews=<?php echo json_encode($submissions->review, JSON_HEX_TAG); ?>;
